...
import { FORGOTPASSWORD_FIELDS } from "../../utils/fields";
...
export default function ForgotPassword() {
    ...
    const [validationErrors, setValidationErrors] = useState(
        FORGOTPASSWORD_FIELDS.map((uf) => uf.name).reduce(
    ...
    return (
        <AuthSection>
            <FormComponent
                ...
                dataTestId="forgot-password-form"
                formFields={FORGOTPASSWORD_FIELDS.map((sf) => (
                    <InputFormRow
                        key={sf.labelName}
                        ...
                        dataTestId={sf.name}
                        typePage="FORGOTPASSWORD_FIELDS"
                    />
                ))}
                submitButton={
                    <FormSubmitButton
                ...
                formHeaderText="Forgot Password Form"
            />
        </AuthSection>
    );
}
